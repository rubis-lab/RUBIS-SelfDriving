...
static const char *CompileLibs[] = {
    /* /net/dagobert/local/work.fh/cm90-git/src_lib/Portings/win64/lib/libcar4sl.a */
    /* /net/dagobert/local/work.fh/cm90-git/src_lib/Portings/win64/lib/libcarmaker4sl.a */
    /* /net/dagobert/local/work.fh/cm90-git/lib/driver/win64/lib/libipgdriver.a */
    /* /net/dagobert/local/work.fh/cm90-git/lib/road/win64/lib/libipgroad.a */
    /* /net/dagobert/local/work.fh/cm90-git/lib/tire/win64/lib/libipgtire.a */
    "libcar4sl.a	CarMaker-Car win64 9.0.2 2020-08-05",
    "libcarmaker4sl.a	CarMaker win64 9.0.2 2020-08-05",
    "libipgdriver.a	IPGDriver win64 9.0.2 2020-08-04",
    "libipgroad.a	IPGRoad win64 9.0.2 2020-08-05",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=90002",
    ...
    "-Wno-misleading-indentation -DCM4SL",
...
tAppStartInfo   AppStartInfo = {
    ...
    "316",          /* App_BuildVersion    */
    "fh",     /* App_CompileUser     */
    "obelix.ipg",         /* App_CompileSystem   */
    "2020-08-05 17:17:06",  /* App_CompileTime */
