...
class TrafficLight {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.remain_time, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.remain_time = _deserializer.float64(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'hellocm_msgs/TrafficLight';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '96a853204d29d897c2c8a468947a4a52';
  }
