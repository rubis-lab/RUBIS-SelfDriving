...
static const char *CompileFlags[] = {
    ...
    "-DWITH_LIDAR_MODULE -DWITH_LINE_MODULE",
    "-DWITH_TrafficLight_MODULE -DWITH_TSIGN_MODULE",
    "-DWITH_VehicleInfo_MODULE -DWITH_UAQ_MODULE",
    "-DWITH_Vehicle_Control_MODULE -DWITH_CMROSIF",
    "-I/opt/ipg/carmaker/linux64-9.0.2/include",
...
tAppStartInfo   AppStartInfo = {
    ...
    "273",          /* App_BuildVersion    */
    "akyeast",     /* App_CompileUser     */
    "akyeast-system-product-name",         /* App_CompileSystem   */
    "2021-02-03 16:09:31",  /* App_CompileTime */
