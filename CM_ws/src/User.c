...
#include "LidarRSI_Model.h"
#include "LineSens_UDP.h"
#include "Vehicle_Control_UDP.h"
#include "TrafficLight_UDP.h"
#include "TrafficSignSens_UDP.h"
#include "VehicleInfo_UDP.h"
#include "UAQ_parameter.h"
...
#ifdef WITH_Vehicle_Control_MODULE
	Vehicle_Control_UDP_User_DeclQuants();
#endif

#ifdef WITH_UAQ_MODULE
	Name_DeclQuants();
#endif
...
#ifdef WITH_LIDAR_MODULE	
	LidarRSI_Config_TestRun_Start_atEnd();
#endif

#ifdef WITH_Vehicle_Control_MODULE
	Vehicle_Control_UDP_User_TestRun_atEnd();
#endif

#ifdef WITH_LINE_MODULE
	Line_Config_TestRun_Start_atEnd();
#endif

#ifdef WITH_TrafficLight_MODULE
	TrafficLight_UDP_User_TestRun_atEnd();
#endif

#ifdef WITH_TSIGN_MODULE
	TSign_Config_TestRun_Start_atEnd();
#endif

#ifdef WITH_VehicleInfo_MODULE
	VehicleInfo_UDP_User_TestRun_atEnd();
#endif

#ifdef WITH_UAQ_MODULE
	Name_TestRun_Start_atend();
#endif
...
{
#ifdef WITH_LIDAR_MODULE	
	LidarRSI_Config_TestRun_End();
#endif	

#ifdef WITH_Vehicle_Control_MODULE
    Vehicle_Control_UDP_TestRun_End ();
#endif  

#ifdef WITH_LINE_MODULE
	Line_Config_TestRun_End();
#endif

#ifdef WITH_TrafficLight_MODULE
	TrafficLight_UDP_TestRun_End();
#endif

#ifdef WITH_TSIGN_MODULE
	TSign_Config_TestRun_End();
#endif

#ifdef WITH_VehicleInfo_MODULE
	VehicleInfo_UDP_TestRun_End();
#endif
...
User_In (const unsigned CycleNo)
{
	...
	return;
#ifdef WITH_Vehicle_Control_MODULE
	Vehicle_Control_UDP_User_In(CycleNo);
#endif					   		 
}
...
#ifdef WITH_Vehicle_Control_MODULE
	Vehicle_Control_UDP_User_VehicleControl_Calc(dt);
#endif 
...
#ifdef WITH_LIDAR_MODULE	
	LidarRSI_Config_Out(CycleNo);
#endif

#ifdef WITH_LINE_MODULE
	Line_Config_Out(CycleNo);
#endif

#ifdef WITH_TrafficLight_MODULE
	TrafficLight_UDP_User_Out(CycleNo);
#endif

#ifdef WITH_TSIGN_MODULE
	TSign_Config_Out(CycleNo);
#endif

#ifdef WITH_VehicleInfo_MODULE
	VehicleInfo_UDP_User_Out(CycleNo);
#endif
...
{
#ifdef WITH_LIDAR_MODULE	
	LidarRSI_Config_Cleanup();
#endif	

#ifdef WITH_Vehicle_Control_MODULE
    Vehicle_Control_UDP_Cleanup();
#endif  
...
#ifdef WITH_TrafficLight_MODULE
	TrafficLight_UDP_Cleanup();
#endif

#ifdef WITH_TSIGN_MODULE
	TSign_Config_Cleanup();
#endif

#ifdef WITH_VehicleInfo_MODULE
	VehicleInfo_UDP_Cleanup();
#endif
