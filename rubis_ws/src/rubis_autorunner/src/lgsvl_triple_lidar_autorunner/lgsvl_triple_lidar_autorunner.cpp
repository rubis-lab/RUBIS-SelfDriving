...
void LGSVLTripleLiDARAutorunner::register_subscribers(){
    ...
    sub_v_[STEP(1)] = nh_.subscribe("/points_raw_l_republished", 1, &LGSVLTripleLiDARAutorunner::points_raw_origin_cb, this);
...
// void LGSVLTripleLiDARAutorunner::nmea_sentence_cb(const autoware_msgs::NDTStat& msg){
